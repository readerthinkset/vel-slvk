"""
Migrate phrase history to Slovak format
Converts legacy keys ('japanese', 'telugu', 'korean') -> 'slovak'
...
LEGACY_KEYS = ["japanese", "telugu", "korean", "hindi", "turkish"]
TARGET_KEY = "slovak"
...
if HISTORY_FILE.exists():
    ...
    print(f"Migrated {updated_count} phrases to Slovak format")
    if updated_count > 0:
    ...
    print("Ready for new Slovak content generation")
else:
